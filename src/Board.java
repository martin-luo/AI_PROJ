...
public class Board
{
	...
	public int[] getOnePossibleMove(String myPlayer,String opponentPlayer,int pickBranchMoveMethod)
	{
		int[] temp=null;
		...
		{
			int pop_index=-1;
			//using method 2 which just simple get back first one of the possible move .
			MinMaxAlgorithm prediction = new MinMaxAlgorithm(2);
			//expand first level get max movement.
			//forming a sub minimax with branch size of all possible move and depth 1
			prediction.makeBestMove(this,1,possibleMove.size(),myPlayer,opponentPlayer);
