...
public class AidUtility
{
	...
	static public int getMaxPoint(int[] pointArray)
	{
		...
		{
			System.out
					.println("X.X --->Error: getMaxx received an empty array .");
		}
	...
	static public void sortByYandX(int[] xPointArray, int[] yPointArray)
	{
		...
		{
			System.out
					.println("X.X ---> Error: sortByxtheny got invalid array");
			System.exit(0);
		}
	...
	static public void swapPoint(int[] xPointArray, int[] yPointArray,
	...
	static public void printPositionArray(int[] xPointArray, int[] yPointArray)
	{
		...
		{
			System.out
					.println("X.X ---> Error: printPositionArray got invalid array");
			System.exit(0);
		}
		...
		{
			System.out
					.println("x:" + xPointArray[i] + "  y:" + yPointArray[i]);
		}
	...
	static public void printPositionArrayList(
			ArrayList<Integer> xPointArrayList,
			ArrayList<Integer> yPointArrayList)
	{
		...
		{
			System.out.println("x:" + xPointArrayList.get(i) + "  y:"
					+ yPointArrayList.get(i));
		}
	}
	...
	static public boolean checkPointInPositionArray(int xPoint, int yPoint,
			int[] xPointArray, int[] yPointArray)
	{
		for (int i = 0; i < xPointArray.length; i++)
		{
	...
	static public void insertIntListToArrayList(int[] from,
	...
	static public BoardDataCircleStructure slicingCellNodeCollectionToBoardDataCircleStructure(
			int from, int to, String circleOwner,
			ArrayList<CellNode> arrayListOfCellNodes)
	{
	...
	static public void arrayListOfCellNodesRemove(int from, int to,
			ArrayList<CellNode> arrayListOfCellNodes)
	{
	 ...
	 * @param oneCircle
	 */
	static public void printBoardDataCircleStructureCellNode(
			BoardDataCircleStructure oneCircle)
	{
