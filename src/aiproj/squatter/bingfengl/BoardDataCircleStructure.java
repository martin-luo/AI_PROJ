...
public class BoardDataCircleStructure
{
	...
	BoardDataCircleStructure(String circleOwner, int[] xPointArray,
			int[] yPointArray)
	{
		this.circleOwner = circleOwner;
	...
	BoardDataCircleStructure(String cycleOwner,
	...
	public void printCircleLevel()
	{
		...
		{
			AidUtility.printPositionArray((int[]) circleLevel[i][0],
					(int[]) circleLevel[i][1]);
			// System.out.println("----");
		}
	}
