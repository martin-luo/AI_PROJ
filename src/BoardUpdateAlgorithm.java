/**
 * This is a part of the project of COMP30024 Artificial Intelligence, 
 * the University of Melbourne. The project is the Game of Squatter. 
 * This is a group work, the members of the group is list below.
 * <p>
 * <b>Rules of Boardgame</b><ul>
 ...
 * </ul>
 * <li>Board is read from stdin (i.e. java Main < input)</li>
 * </ul>
 * <p>
...
{
	/**
	 * This is an abstract class, it's used to update the status of cells on the board.
	 */
