...
public class BoardGame implements Game<Bingfengl, int[], String>
{
	...
	BoardGame(Bingfengl oneBingfengl)
	{
		...
		// currentPlayerPiece = (currentPlayerPiece == Piece.WHITE ? Piece.BLACK
		// : Piece.WHITE);
	}
	...
	{
		// this is a dummy one .
		// this only reurn how many movements are possible .. Integer means
		// nothing ,they all == 1
	...
	public Bingfengl getResult(Bingfengl state, int[] action)
	{
		...
		if (onePossibleMove != null)
		{
			...
			// currentPlayerPiece = (currentPlayerPiece == Piece.WHITE ?
